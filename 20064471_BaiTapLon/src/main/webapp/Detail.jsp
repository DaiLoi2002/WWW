            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="product-thumbnail">
                        <div class="col-md-10 col-sm-10 col-xs-10">
                            <!-- Product Image -->
                            <div class="thumb-main-image"><a href=""><img src="${detail.image}" alt="Product Image"></a></div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="product-info">
                        ...
                        <span class="product-availability"><span class="strong-text">Availability:</span> In Stock</span>
                    </div>
                    ...
                    <form action="addproduct" method="post" class="purchase-form">
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="single-product">
                                <div class="product-block">
                                    <img src="images/product-1.jpg" alt="Related Product 1" class="thumbnail">
